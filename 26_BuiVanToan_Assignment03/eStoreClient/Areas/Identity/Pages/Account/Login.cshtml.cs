...
namespace eStoreClient.Areas.Identity.Pages.Account
{
    public class LoginModel : PageModel
    {
        ...
        public LoginModel(SignInManager<Member> signInManager, ILogger<LoginModel> logger, IConfiguration configuration, UserManager<Member> userManager)
        {
            ...
            AuthenUrl = "https://localhost:7186/api/Authentication";
